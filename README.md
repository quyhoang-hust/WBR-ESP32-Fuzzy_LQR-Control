# 🤖 Wheeled-Bipedal Robot (WBR) - Fuzzy LQR Control System

Dự án phát triển hệ thống điều khiển cho robot lưỡng thăng có bánh tích hợp khớp chân thay đổi độ cao, sử dụng vi điều khiển **ESP32** và hệ điều hành thời gian thực **FreeRTOS**.
...
* `Documentation/`: Hình ảnh robot vận hành và kết quả mô phỏng/debug.
